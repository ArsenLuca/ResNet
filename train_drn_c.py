...
def main():
    if args.data_type == "cifar10":
        ...
        units = per_unit*3
        symbol = drn_c(units=units, num_stage=3, filter_list=filter_list, num_class=args.num_classes,
        ...
        if args.depth == 18:
            ...
            raise ValueError("no experiments done on detph {}, you can do it youself".format(args.depth))
        symbol = drn_c(units=units, num_stage=4, filter_list=[64, 256, 512, 1024, 2048] if args.depth >=50
